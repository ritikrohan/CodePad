    ...
    WebView.onMessage = function (message) {
      ...
      switch(action.type) {
        ...
        case '${actions.getTitleHtml}':
          ...
          WebView.send(JSON.stringify({type: '${messages.TITLE_HTML_RESPONSE}', data: html}));
          break;
        case '${actions.getTitleText}':
          var html = zss_editor.getTitleText();
          WebView.send(JSON.stringify({type: '${messages.TITLE_TEXT_RESPONSE}', data: html}));
          break;
        case '${actions.getContentHtml}':
          var html = zss_editor.getContentHTML();
          WebView.send(JSON.stringify({type: '${messages.CONTENT_HTML_RESPONSE}', data: html}));
          break;
        ...
        case '${actions.getSelectedText}':
          ...
          WebView.send(JSON.stringify({type: '${messages.SELECTED_TEXT_RESPONSE}', data: selectedText}));
          break;
